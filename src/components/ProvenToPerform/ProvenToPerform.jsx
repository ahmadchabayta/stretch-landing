...
const ProvenToPerform = () => {
  ...
  return (
    <Section className="relative bg-black! ">
      <div
        className="absolute inset-0 z-0 invert"
        style={{
      ...
      <AppBoundary>
        ...
        <TrueGlassContainer className="flex items-center! justify-center! overflow-hidden  text-gray-500/30">
          <Flex
          ...
          >
            ...
            >
              ...
              <Typography
                ...
                className="max-w-[90%] px-4 py-6 md:px-6 md:py-8 text-gray-700/50"
              >
              ...
              <Typography
                ...
                className="max-w-[90%] absolute right-[6%] -bottom-12 sm:-bottom-14 md:-bottom-16 lg:-bottom-18 xl:-bottom-20 text-white"
              >
