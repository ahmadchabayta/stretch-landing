...
const Textarea = forwardRef(
  (
    ...
    const baseStyles =
      "w-full border-2 rounded-[0.5rem] px-2 sm:px-3 lg:px-5 py-2 sm:py-2.5 lg:py-3 ltr:font-poppins rtl:font-tajawal text-[15px] sm:text-[16px] lg:text-[17px] text-black placeholder:text-gray-400 outline-none resize-none transition-all";
