        ...
        >
          <TrueGlassContainer className="flex justify-self-center items-center! justify-center! overflow-hidden text-gray-500/30">
            ...
            >
              <Glass
                accentColor="#FFFFFF"
                className="mb-[80px] xl:mb-0 flex flex-col touch-none select-none items-center justify-center min-h-[152px] max-h-[172px] w-full max-w-[75vw] xl:max-w-[40vw] z-50 will-change-transform transform-[translate3d(0,0,0)] backface-hidden"
              >
                <Flex
                  align="items-center"
                  justify="justify-center"
                  className={`absolute -z-50 h-16 w-16 sm:h-20 sm:w-20 md:h-24 md:w-24 pointer-events-none bg-primary rounded-full will-change-transform backface-hidden ${isArabic ? "right-0 top-0 translate-y-[-50%] translate-x-[50%]" : "left-0 top-0 translate-y-[-50%] translate-x-[-50%]"}`}
                >
                  <svg
                ...
                <Typography
                  ...
                  className="flex items-center justify-center min-w-[300px] lg:min-w-[500px] max-w-[90%] min-h-40 px-4 py-6 md:px-6 md:py-8 text-gray-700/50 "
                >
              ...
              >
                <Flex
                  align="items-center"
                  justify="justify-center"
                  className={`absolute -z-50 h-16 w-16 sm:h-20 sm:w-20 md:h-24 md:w-24 pointer-events-none bg-primary rounded-full  will-change-transform backface-hidden ${isArabic ? "left-0 top-0 translate-y-[50%] translate-x-[-50%]" : "right-0 bottom-0 translate-y-[50%] translate-x-[50%]"}`}
                >
                  <svg
                    className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 text-white"
                    fill="currentColor"
