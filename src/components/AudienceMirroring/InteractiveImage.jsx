...
const InteractiveImage = ({ data }) => (
  ...
  >
    <div className="relative h-full w-full">
      ...
      <div
        className="primary-btn z-2 bg-primary absolute top-[48%] left-[50%] flex h-[41px] w-[309px] max-w-none translate-x-[-50%] items-center justify-center rounded-sm p-[8px_24px] text-center font-[Tajawal] text-[16px] font-semibold text-white"
